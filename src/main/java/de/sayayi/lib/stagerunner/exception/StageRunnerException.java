...
{
  /**
   * Constructs a new stage runner exception with the specified detail message.
  ...
  /**
   * Constructs a new stage runner exception with the specified detail message and cause.
   * <p>
